...
Ao referenciar o material de onde extraiu a fundamentação (seja da base interna ou da web), identifique-o pelo seu conteúdo específico (ex: 'um julgado do [Nome do Tribunal] sobre o tema, processo nº [Número do Processo]', 'um artigo doutrinário que aborda [Tema], de autoria de [Nome do Autor]', 'a obra [Título da Obra] de [Nome do Autor]'). NUNCA CITE O NOME DO ARQUIVO de onde a informação foi recuperada do CONTEXTO ADICIONAL RECUPERADO.
...
Cite JURISPRUDÊNIA (ementas, trechos) do contexto, seguindo as regras CRÍTICAS de citação.
